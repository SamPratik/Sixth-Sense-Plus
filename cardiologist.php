<?php include_once("cardiologistGoogleMapSearch.php"); ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<body onLoad="initialize()">
	...
	<!--------Heading----------------->
	<h1 style="text-align:center;">Cardiologist</h1><br/><br/>
        ...
        <div class="doc-info" style="float:left;margin-top:-20px;margin-left:100px; width:480px; height:475px; border:2px solid black; border-radius:15px;">
            <form style="float:left" action="cardiologist.php" method="get">
            ...
            margin-left: 31px; overflow-y:scroll; overflow-x:scroll;">
            	<?php include_once("cardiologistSearch.php"); ?>
            </div>
        </div>
        
        <!----------Google Map Search DIV----------->
        <div class="map-search" style="margin-top:-20px;float:left;width:480px; height:475px; margin-left:50px; border:2px solid black; border-radius:15px;">
            <form style="float:left" action="cardiologist.php" method="get">
