<?php include_once("surgeonGoogleMapSearch.php"); ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<body onLoad="initialize()">
	...
	<!--------Heading----------------->
	<h1 style="text-align:center;">Surgeon</h1><br/><br/>
        ...
        <div class="doc-info" style="float:left;margin-top:-20px;margin-left:100px; width:480px; height:475px; border:2px solid black; border-radius:15px;">
            <form style="float:left" action="surgeon.php" method="get">
            ...
            margin-left: 31px; overflow-y:scroll; overflow-x:scroll;">
            	<?php include_once("surgeonSearch.php"); ?>
            </div>
        </div>
