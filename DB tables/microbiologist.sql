...
--
-- Table structure for table `microbiologist`
--

CREATE TABLE IF NOT EXISTS `microbiologist` (
...
--
-- Dumping data for table `microbiologist`
--

INSERT INTO `microbiologist` (`id`, `doc_name`, `designation`, `organization`, `chamber`, `location`, `phone`, `keywords`) VALUES
