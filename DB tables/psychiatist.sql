...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2016 at 01:44 AM
...
--
-- Table structure for table `psychiatist`
--

CREATE TABLE IF NOT EXISTS `psychiatist` (
...
--
-- Dumping data for table `psychiatist`
--

INSERT INTO `psychiatist` (`id`, `doc_name`, `designation`, `organization`, `chamber`, `location`, `phone`, `keywords`) VALUES
