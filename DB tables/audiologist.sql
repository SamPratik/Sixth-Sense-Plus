...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2016 at 01:39 AM
...
--
-- Table structure for table `audiologist`
--

CREATE TABLE IF NOT EXISTS `audiologist` (
...
--
-- Dumping data for table `audiologist`
--

INSERT INTO `audiologist` (`id`, `doc_name`, `designation`, `organization`, `chamber`, `location`, `phone`, `keywords`) VALUES
