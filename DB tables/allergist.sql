...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2016 at 01:34 AM
...
--
-- Table structure for table `allergist`
--

CREATE TABLE IF NOT EXISTS `allergist` (
...
--
-- Dumping data for table `allergist`
--

INSERT INTO `allergist` (`id`, `doc_name`, `designation`, `organization`, `chamber`, `location`, `phone`, `keywords`) VALUES
